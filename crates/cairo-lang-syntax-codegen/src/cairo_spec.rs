...
pub fn get_spec() -> Vec<Node> {
    ...
    .add_enum(
        EnumBuilder::new("Trivium")
            ...
            .node_with_explicit_kind("SingleLineDocComment", "SingleLineDocComment")
            .node_with_explicit_kind("SingleLineInnerComment", "SingleLineInnerComment")
    ...
    .add_list("SingleLineInnerComment", "Comment")
    .add_list("SingleLineDocComment", "Comment")
    .add_enum(
      EnumBuilder::new("Comment")
      .node_with_explicit_kind("CommentTrivia", "TokenCommentTrivia")
      .node_with_explicit_kind("InlineLink", "DocInlineReferenceLink")
      .node_with_explicit_kind("ImpliedLink", "DocImpliedReferenceLink")
    )
    // --- Expressions ---
    ...
    .add_struct(StructBuilder::new("DocInlineReferenceLink")
      .node("lbrack", "TerminalLBrack")
      .node("link_display", "TerminalShortString")
      .node("rbrack", "TerminalRBrack")
      .node("lparen", "TerminalLParen")
      .node("link_path", "TerminalShortString")
      .node("rparen", "TerminalRParen")
    )
    .add_struct(StructBuilder::new("DocImpliedReferenceLink")
      .node("lbrack", "TerminalLBrack")
      .node("link", "TerminalShortString")
      .node("rbrack", "TerminalRBrack")
    )
    // --- Skipped nodes ---
